...
describe('PublicKey', function() {
  ...
  describe('#toAddress', function() {
    ...
    it('should output this known mainnet address correctly', function() {
      ...
      address.toString().should.equal('t1SyWtMJekocc2sTEJGt222nwKbog83G51q');
    });
  ...
  describe('hashes', function() {
    ...
    var data = [
      ['5HxWvvfubhXpYYpS3tJkw6fq9jE9j18THftkZjHHfmFiWtmAbrj', 't1h8SqgtM3QM5e2M8EzhhT1yL2PXXtA6oqe'],
      ['5KC4ejrDjv152FGwP386VD1i2NYc5KkfSMyv1nGy1VGDxGHqVY3', 't1Xxa5ZVPKvs9bGMn7aWTiHjyHvR31XkUst'],
      ['Kwr371tjA9u2rFSMZjTNun2PXXP3WPZu2afRHTcta6KxEUdm1vEw', 't1ffus9J1vhxvFqLoExGBRPjE7BcJxiSCTC'],
      ['L3Hq7a8FEQwJkW1M2GNKDW28546Vp5miewcCzSqUD9kCAXrJdS3g', 't1VJL2dPUyXK7avDRGqhqQA5bw2eEMdhyg6']
    ];

    it('should generate address from wip private key', function() {
